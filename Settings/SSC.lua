...
local items = {
  ...
  [30048] = {boss = 623, slot =  1, xtype =  4, account = 5, cost = 0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Brighthelm of Justice
  [30049] = {boss = 623, slot = 15, xtype =  0, account = 5, cost = 400, note = "BiS: RDr Arcane RSh Destro Affli Opt: Fire"}, -- Fathomstone
  [30050] = {boss = 623, slot = 10, xtype =  1, account = 5, cost = 80, note = "Opt: Destro Affli"}, -- Boots of the Shifting Nightmare
  [30051] = {boss = 623, slot = 17, xtype =  0, account = 5, cost =  0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Idol of the Crescent Goddess
  [30052] = {boss = 623, slot = 11, xtype =  0, account = 5, cost = 200, note = "BiS: TDr MDr Hu Ro MSh Opt: Arms Fury"}, -- Ring of Lethality
  [30053] = {boss = 623, slot =  3, xtype =  4, account = 5, cost = 100, note = "Opt: Arms Fury"}, -- Pauldrons of the Wardancer
  [30054] = {boss = 623, slot =  5, xtype =  3, account = 5, cost = 200, note = "Opt: Hu"}, -- Ranger-General's Chestguard
  ...
  [30056] = {boss = 623, slot =  5, xtype =  1, account = 5, cost = 150, note = "Opt: RDr Arcane Fire Destro Affli"}, -- Robe of Hateful Echoes
  [30629] = {boss = 623, slot = 12, xtype =  0, account = 5, cost = 300, note = "BiS: TPa"}, -- Scarab of Displacement
  [30664] = {boss = 623, slot = 12, xtype =  0, account = 5, cost = 0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Living Root of the Wildheart
  [32516] = {boss = 623, slot =  6, xtype =  1, account = 5, cost = 150, note = "BiS: HPr Opt: HSh"}, -- Wraps of Purification
  [33055] = {boss = 623, slot = 11, xtype =  0, account = 5, cost =  0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Band of Vile Aggression
  ...
  [30059] = {boss = 624, slot =  2, xtype =  0, account = 5, cost = 90, note = "Opt: Hu Arms Fury"}, -- Choker of Animalistic Fury
  [30060] = {boss = 624, slot = 10, xtype =  2, account = 5, cost = 90, note = "Opt: TDr MDr Hu"}, -- Boots of Effortless Striking
  ...
  [30063] = {boss = 624, slot = 17, xtype =  0, account = 5, cost = 0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Libram of Absolute Truth
  ...
  [30065] = {boss = 624, slot =  5, xtype =  4, account = 5, cost = 0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Glowing Breastplate of Truth
  [30066] = {boss = 624, slot = 10, xtype =  3, account = 5, cost = 90, note = "Opt: HSh"}, -- Tempest-Strider Boots
  ...
  -- Karathress:
  [30090] = {boss = 626, slot = 16, xtype =  8, account = 5, cost = 0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- World Breaker
  ...
  [30663] = {boss = 626, slot = 12, xtype =  0, account = 5, cost = 0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Fathom-Brooch of the Tidewalker

  -- Morogrim:
  [30008] = {boss = 627, slot =  2, xtype =  0, account = 5, cost = 90, note = "Opt: Arcane TPa"}, -- Pendant of the Lost Ages
  [30068] = {boss = 627, slot =  8, xtype =  3, account = 5, cost = 0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Girdle of the Tidal Call
  [30075] = {boss = 627, slot =  5, xtype =  2, account = 5, cost = 150, note = "Opt: HDr"}, -- Gnarled Chestpiece of the Ancients
  [30079] = {boss = 627, slot =  3, xtype =  1, account = 5, cost = 100, note = "Opt: RDr Arcane Fire Destro Affli"}, -- Illidari Shoulderpads
  ...
  [30084] = {boss = 627, slot =  3, xtype =  4, account = 5, cost = 0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Pauldrons of the Argent Sentinel
  [30085] = {boss = 627, slot =  3, xtype =  3, account = 5, cost = 100, note = "Opt: Hu"}, -- Mantle of the Tireless Tracker
  ...
  [33058] = {boss = 627, slot = 11, xtype =  0, account = 5, cost =  0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Band of the Vigilant

  -- Lady Vashj:
  [30102] = {boss = 628, slot =  5, xtype =  4, account = 5, cost = 350, note = "Opt: MPa Arms Fury"}, -- Krakken-Heart Breastplate
  [30103] = {boss = 628, slot = 13, xtype =  5, account = 5, cost = 500, note = "BiS: Ro TWa"}, -- Fang of Vashj
  [30104] = {boss = 628, slot = 10, xtype =  3, account = 5, cost = 350, note = "BiS: Hu Opt: MPa MSh"}, -- Cobra-Lash Boots
  [30105] = {boss = 628, slot = 17, xtype = 12, account = 5, cost = 600, note = "BiS: Hu Arms Fury"}, -- Serpent Spine Longbow
  [30106] = {boss = 628, slot =  8, xtype =  2, account = 5, cost = 400, note = "BiS: TDr MDr MPa Ro MSh TWa Arms Fury Opt: Hu"}, -- Belt of One-Hundred Deaths
  [30107] = {boss = 628, slot =  5, xtype =  1, account = 5, cost = 400, note = "BiS: Fire RPr RSh Destro Affli Opt: RDr Arcane"}, -- Vestments of the Sea-Witch
  [30108] = {boss = 628, slot = 14, xtype =  8, account = 5, cost = 500, note = "BiS: HDr HPa HPr HSh"}, -- Lightfathom Scepter
  [30109] = {boss = 628, slot = 11, xtype =  0, account = 5, cost = 400, note = "BiS: RDr Fire RPr RSh Destro Affli Opt: TPa"}, -- Ring of Endless Coils
  [30110] = {boss = 628, slot = 11, xtype =  0, account = 5, cost = 400, note = "BiS: HDr HPa HPr Opt: HSh"}, -- Coral Band of the Revived
  [30111] = {boss = 628, slot =  3, xtype =  2, account = 5, cost = 300, note = "Opt: HDr"}, -- Runetotem's Mantle
  [30112] = {boss = 628, slot =  7, xtype =  4, account = 5, cost = 0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Glorious Gauntlets of Crestfall
  [30621] = {boss = 628, slot = 12, xtype =  0, account = 5, cost = 0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Prism of Inner Calm

  -- Trash:
  [30620] = {boss =   1, slot = 12, xtype =  0, account = 5, cost = 300, note = "BiS: TWa Opt: TDr"}, -- Spyglass of the Hidden Fleet
  [30023] = {boss =   1, slot = 17, xtype =  0, account = 5, cost =  0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Totem of the Maelstrom
  ...
  -- Patterns:
  [30282] = {boss =   1, slot = 10, xtype =  1, account = 5, cost = 50, note = "BiS: RDr Arcane Fire Destro Affli"}, -- Pattern: Boots of Blasting
  ...
  [30306] = {boss =   1, slot = 10, xtype =  2, account = 5, cost = 50, note = "BiS: MSh"}, -- Pattern: Boots of Utter Darkness
  ...
  [30307] = {boss =   1, slot = 10, xtype =  3, account = 5, cost = 50, note = "Opt: Hu"}, -- Pattern: Boots of the Crimson Hawk
}
