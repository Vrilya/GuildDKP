...
local items = {
  ...
  [29921] = {boss = 730, slot =  5, xtype =  3, account = 5, cost = 100, note = "Opt: HSh"}, -- Fire Crest Breastplate
  ...
  [30447] = {boss = 730, slot = 12, xtype =  0, account = 5, cost = 0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Tome of Fiery Redemption
  [30448] = {boss = 730, slot = 12, xtype =  0, account = 5, cost = 0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Talon of Al'ar
  ...
  [29985] = {boss = 731, slot =  9, xtype =  3, account = 5, cost = 100, note = "Opt: Hu"}, -- Void Reaver Greaves
  ...
  [30619] = {boss = 731, slot = 12, xtype =  0, account = 5, cost = 0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Fel Reaver's Piston
  ...
  [29962] = {boss = 732, slot = 13, xtype =  5, account = 5, cost = 300, note = "Opt: Ro"}, -- Heartrazor
  [29965] = {boss = 732, slot =  8, xtype =  4, account = 5, cost = 50, note = "Opt: HPa"}, -- Girdle of the Righteous Path
  ...
  [29977] = {boss = 732, slot =  9, xtype =  1, account = 5, cost = 100, note = "Opt: HDr HPr"}, -- Star-Soul Breeches
  ...
  [30446] = {boss = 732, slot = 12, xtype =  0, account = 5, cost = 150, note = "BiS: Arms"}, -- Solarian's Sapphire
  [30449] = {boss = 732, slot = 12, xtype =  0, account = 5, cost = 0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Void Star Talisman
  ...
  [29990] = {boss = 733, slot =  1, xtype =  1, account = 5, cost = 100, note = "Opt: HPr"}, -- Crown of the Sun
  ...
  -- Trash:
  [30020] = {boss =   1, slot =  8, xtype =  1, account = 5, cost =  0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Fire-Cord of the Magus
  ...
  [30028] = {boss =   1, slot = 11, xtype =  0, account = 5, cost = 200, note = "BiS: TPa"}, -- Seventh Ring of the Tirisfalen
  [30029] = {boss =   1, slot =  7, xtype =  2, account = 5, cost = 0, note = "NOT BIS FOR ANYONE, Roll it out"}, -- Bark-Gloves of Ancient Wisdom
